...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s FBTC-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  FBTC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded FBTC transaction") + "\n" +
              "  FBTC-tx [options] -create [commands]   " + _("Create hex-encoded FBTC transaction") + "\n" +
              "\n";
