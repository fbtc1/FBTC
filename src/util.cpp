...
const char * const BITCOIN_CONF_FILENAME = "FBTC.conf";
const char * const BITCOIN_PID_FILENAME = "FBTC.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FBTC";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/FBTC";
#else
    // Unix
    return pathRet / ".FBTC";
#endif
